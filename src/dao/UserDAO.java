...
public enum UserDAO {
	...
	public User getUserByEmail(String email, String password) throws SQLException, UserDataException {
		String sqlQuery = "SELECT " + "first_name, last_name, email, password, gender, city, "
		...
		try (PreparedStatement ps = connection.prepareStatement(sqlQuery)) {
			...
			User user = null;
			if (!resultSet.getString("email").isEmpty() && resultSet.getString("password").equals(password)) {
